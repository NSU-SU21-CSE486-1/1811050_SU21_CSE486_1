...
public class ClubFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button myClubsButton = view.findViewById(R.id.myClubsButton);
        Button joinedClubsButton = view.findViewById(R.id.joinedClubsButton);
        Button searchClubsButton = view.findViewById(R.id.searchClubsButton);
